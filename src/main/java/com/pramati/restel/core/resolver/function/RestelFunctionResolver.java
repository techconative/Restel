...
public class RestelFunctionResolver {
  ...
  public static Object resolveAddOperation(
      Map<String, Object> payload, String data, List<Object> elements) {
    // TODO Implement the logic
    // resolveAddVariable(payload, data, elements);
    return null;
  }

  private static Map<String, Object> resolveAddVariable(
      Map<String, Object> context, String variableName, List<Object> elements) {
  ...
  private static List<Object> resolveAddVariableArray(
      List<Object> context, String variableName, List<Object> elements) {
   ...
   *     com.pramati.restel.core.model.functions.FunctionOps}
   ...
   *     com.pramati.restel.core.model.functions.FunctionOps} (like add / remove).
   * @param variableName name of the variable in the nested context map which needs to undergo a
   *     {@link com.pramati.restel.core.model.functions.FunctionOps}.
  ...
  /**
   * resolve the variable by removing the indexed value of the array. Eg: for context:-
   * {userGroup:[{name: Adam},{name:Sam},{name:Tom}]} , the variable userGroup[1,2] will return the
   * object:- {name:Adam}
   *
  ...
  private static Object resolveRemoveArray(String variable, Map<String, Object> context) {
    ...
    if (m.find() && object instanceof List) {
      ...
      for (int numb :
          Arrays.stream(m.group(1).split(COMMA))
              .map(Integer::valueOf)
