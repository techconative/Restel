...
public class Utils {
     ...
     * <i>findAndApply("some_snake_case", "_[a-z]",(x) ->
     * x.replace("_","").toUpperCase())</i>
     *
     ...
     */
    public static String findAndApplyOnString(String src, String pattern,
                                              Function<String, Object> txr) {
        if (src == null) {
            return null;
        }
    ...
    public static Object findAndApplyOnObject(String src, String pattern,
                                              Function<String, Object> txr) {
        if (src == null) {
            return null;
        }
        ...
        while (m.find()) {
            ...
            if (!(res instanceof String) && !Objects.isNull(res))
                return res;
            if (res != null) {
                sb.append(res);
            }
    ...
    /**
     * Gets the string representation of the given object. Gets the empty string
     * if the object is null.
     *
     * @param obj The object whose str rep to be returned.
     * @return toString() value of the object if the object is not null. empty
     * string otherwise.
     */
    ...
    /**
     * if response header is empty return true or else check if the response header has content-type - application/json.
     *
     * @param restResponse
     * @return
     */
    public static String getMediaType(RESTResponse restResponse) {
        ...
        try {
            String content = (String) restResponse.getHeaders().get(HttpHeaders.CONTENT_TYPE.toLowerCase());
    ...
    /**
     * remove the braces inside the text.
     * Eg: data:- ${Tom.Response.Value} will return Tom.Response.Value .
     *
