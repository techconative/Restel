...
/**
 * Abstract implementation of the context, can be used to represent the context
 * of a test method, or test execution or test suite.
 *
 * @author kannanr
 */
public abstract class AbstractContext {
    ...
    /**
     * Resolves the value of the given key in the current context. If not available
     * passes it to the parent context for the resolution.
     *
