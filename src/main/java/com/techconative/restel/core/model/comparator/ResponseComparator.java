...
/**
 * Contract defining the comparator that compares the rest response with the expected output
 *
 * @author kannanr
 */
public interface ResponseComparator {
  /**
   * Compares the given response with the expected output based on the given context.
   *
   ...
   */
  public default boolean compare(Object response, Object expectedOutput) {
