...
import com.techconative.restel.swagger.RestelWriterApplication;
...
public class RestelWriterApplicationTest {
    ...
    public void testApplicationToPath() throws IOException {
        ...
        RestelWriterApplication.main(new String[]{"src/test/resources/swagger/petstore_3.json", writepath});
