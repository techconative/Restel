...
public class RestelAssertionResolverTest {
  ...
  public void testResolveAssertEqualForString() {
    RestelAssertion assertion =
        createAssertion("Sample", AssertType.EQUAL, "${Name}", "Tom", "Success");
  ...
  public void testResolveAssertNotEqualForString() {
    RestelAssertion assertion =
        createAssertion("Sample", AssertType.NOT_EQUAL, "${Name}", "Ram", "Success");
    TestContext context = new TestContext("Sample");
    context.addValue("Name", "Tom");
  ...
  public void testResolveAssertEqualForJson() {
    ...
    RestelAssertion assertion =
        createAssertion(
            ...
            AssertType.EQUAL,
            "${Name}",
            ObjectMapperUtils.convertToJsonNode(data).toPrettyString(),
            "Success");
    TestContext context = new TestContext("Sample");
  ...
  public void testResolveAssertNotEqualForJson() {
    ...
    RestelAssertion assertion =
        createAssertion(
            ...
            "${Name}",
            ObjectMapperUtils.convertToJsonNode(Arrays.asList(data)).toPrettyString(),
            "Success");
    TestContext context = new TestContext("Sample");
    context.addValue("Name", data);
  ...
  public void testResolveAssertEqualForJsonFailure() {
    ...
    TestContext context = new TestContext("Sample");
    context.addValue("Name", data);
    RestelAssertionResolver.resolve(
        context,
        createAssertion(
            "Sample", AssertType.EQUAL, "${Name}", data.get("animals").toString(), null));
  }
  ...
  public void testResolveAssertEqualForStringFailure() {
    ...
    RestelAssertionResolver.resolve(
        context, createAssertion("Sample", AssertType.EQUAL, "${Name}", "Ram", null));
  }
  ...
  public void testResolveAssertTrue() {
    ...
    RestelAssertion assertion =
        createAssertion("Sample", AssertType.TRUE, null, "${data.Admin}", null);
    RestelAssertionResolver.resolve(context, assertion);
    Assert.assertEquals("Sample", assertion.getName());
  }
  ...
  public void testResolveAssertNull() {
    ...
    context.addValue("data", Map.of("name", "Tom", "Admin", "True"));
    RestelAssertion assertion =
        createAssertion("Sample", AssertType.NULL, null, "${data.Admin.date}", null);
    RestelAssertionResolver.resolve(context, assertion);
    Assert.assertEquals("Sample", assertion.getName());
  }
  ...
  public void testResolveAssertNotNull() {
    ...
    context.addValue("data", Map.of("name", "Tom", "Admin", "True"));
    RestelAssertion assertion =
        createAssertion("Sample", AssertType.NOT_NULL, null, "${data.Admin}", null);
    RestelAssertionResolver.resolve(context, assertion);
    Assert.assertEquals("Sample", assertion.getName());
  }
  ...
  public void testResolveAssertFalse() {
    ...
    RestelAssertion assertion =
        createAssertion("Sample", AssertType.FALSE, null, "${data.Admin}", null);
    RestelAssertionResolver.resolve(context, assertion);
    Assert.assertEquals("Sample", assertion.getName());
  }
  ...
  public void testResolveAssertFalseInvalid() {
    ...
    RestelAssertion assertion =
        createAssertion("Sample", AssertType.FALSE, null, "${data.name}", null);
    RestelAssertionResolver.resolve(context, assertion);
  }
  ...
  public void testResolveAssertGreater() {
    ...
    RestelAssertion assertion =
        createAssertion("Sample", AssertType.GREATER, "99999990", "${data.PhoneNumber}", null);
    RestelAssertionResolver.resolve(context, assertion);
    Assert.assertEquals("Sample", assertion.getName());
  }
  ...
  public void testResolveAssertGreaterFailure() {
    ...
    context.addValue("data", Map.of("name", "Tom", "PhoneNumber", "9999999999"));
    RestelAssertion assertion =
        createAssertion("Sample", AssertType.GREATER, "99999999990", "${data.PhoneNumber}", null);
    RestelAssertionResolver.resolve(context, assertion);
  }
  ...
  public void testResolveAssertLesser() {
    ...
    context.addValue("data", Map.of("name", "Tom", "PhoneNumber", "9999999999"));
    RestelAssertion assertion =
        createAssertion("Sample", AssertType.LESSER, "${data.PhoneNumber}", "99999990", null);
    RestelAssertionResolver.resolve(context, assertion);
    Assert.assertEquals("Sample", assertion.getName());
  }
  ...
  public void testResolveAssertLesserFailure() {
    ...
    context.addValue("data", Map.of("name", "Tom", "PhoneNumber", "9999999999"));
    RestelAssertion assertion =
        createAssertion("Sample", AssertType.LESSER, "${data.PhoneNumber}", "999999999990", null);
    RestelAssertionResolver.resolve(context, assertion);
  }
  ...
  public void testResolveAssertLesserInvalid() {
    ...
    context.addValue("data", Map.of("name", "Tom", "PhoneNumber", "9999999999"));
    RestelAssertion assertion =
        createAssertion("Sample", AssertType.LESSER, "${data.PhoneNumber}", "99999999r0", null);
    RestelAssertionResolver.resolve(context, assertion);
  }
  ...
  public void testResolveAssertGreaterInvalid() {
    ...
    context.addValue("data", Map.of("name", "Tom", "PhoneNumber", "9999999999"));
    RestelAssertion assertion =
        createAssertion("Sample", AssertType.LESSER, "99999999r0", "${data.PhoneNumber}", null);
    RestelAssertionResolver.resolve(context, assertion);
  }

  private RestelAssertion createAssertion(
      String name, AssertType type, String expected, String actual, String message) {
