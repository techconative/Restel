...
public class RestelFunctionResolverTest {
    ...
    public void testResolveRemoveOperationWithMap() {
        ...
        Map<String, Object> out = (Map<String, Object>) RestelFunctionResolver.resolveRemoveOperation(context, "data.response.value", null);
        Assert.assertTrue( ObjectMapperUtils.convertToJsonNode(out).get("data").get("response").isEmpty());
    }
