...
public class RestelFunctionExecutorTest {
    ...
    public void testExecRemoveFunction() {
        ...
        Assert.assertEquals("Tom", ObjectMapperUtils.convertToJsonNode(out).get("value").get(0).asText());
    ...
    public void testExecRemoveFunctionWithArray() {
        ...
        Map<String, Object> out = (Map<String, Object>) executor.execRemoveFunction(function);
        Assert.assertEquals("Tom", ObjectMapperUtils.convertToJsonNode(out).get("value").get(0).get("names").get(0).asText());
    }
    ...
    public void testExecRemoveFunctionWithoutSyntax() {
        ...
        Map<String, Object> out = (Map<String, Object>) executor.execRemoveFunction(function);
        Assert.assertEquals("Tom", ObjectMapperUtils.convertToJsonNode(out).get("exec").get("data").get("req").get("value").get(0).get("names").get(0).asText());
