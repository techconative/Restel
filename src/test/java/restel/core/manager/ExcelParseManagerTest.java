...
public class ExcelParseManagerTest {
  ...
  @Test
  public void testGetTestMethodsTest()
  ...
  @Test
  public void testGetExecGroupsTest()
      throws NoSuchMethodException, NoSuchFieldException, IllegalAccessException,
          InvocationTargetException {
    invoke("src/test/resources/Sample_Suite_definition.xlsx");
  ...
  @Test
  public void testGetBaseConfigTest()
      throws NoSuchMethodException, NoSuchFieldException, IllegalAccessException,
          InvocationTargetException {
    invoke("src/test/resources/Sample_Suite_definition.xlsx");
  ...
  public void testgetTestMethodsWithEmpty()
      throws NoSuchMethodException, NoSuchFieldException, IllegalAccessException,
          InvocationTargetException {
  ...
  @Test(expected = Exception.class)
  public void testGetSuitesWithEmpty()
      throws NoSuchMethodException, NoSuchFieldException, IllegalAccessException,
          InvocationTargetException {
  ...
  @Test(expected = Exception.class)
  public void testGetExecutionWithEmpty()
      throws NoSuchMethodException, NoSuchFieldException, IllegalAccessException,
          InvocationTargetException {
  ...
  @Test(expected = Exception.class)
  public void testGetExecutionNoFile()
      throws NoSuchMethodException, NoSuchFieldException, IllegalAccessException,
          InvocationTargetException {
    invoke("");
    excelParseManager.getExecGroups();
  ...
  @Test(expected = Exception.class)
  public void testGetExecutionInvalidFile()
      throws NoSuchMethodException, NoSuchFieldException, IllegalAccessException,
          InvocationTargetException {
