...
public class ContextManagerTest {
    ...
    public void testReplaceContextVariablesForMapObject() {
        ...
        Map<String, String> reaplcedMap = (Map) context
                .replaceContextVariables(null, a);
    ...
    public void testReplaceContextVariablesForArray() {
        ...
        // -> value
        Assert.assertEquals(Arrays.asList("value"), context
                .replaceContextVariables(testContext, Arrays.asList("${key${key}}")));
    }
    ...
    public void testReplaceContextVariablesWithNestedKey() {
        ...
        Assert.assertEquals(Arrays.asList("value"), context
                .replaceContextVariables(testContext, (Object) Arrays.asList("${key${key}}")));
    }
    ...
    public void testReplaceContextVariablesWithCollection() {
        ...
        Assert.assertEquals(Arrays.asList("value"), context
                .replaceContextVariables(testContext, "${key${result.resp.k[0]}}"));
    }
    ...
    public void testReplaceContextVariablesForNull() {
        ...
        Assert.assertEquals("", context
                .replaceContextVariables(null, "${value}"));
    }
    ...
    public void testReplaceContextVariablesOfMap() {
        ...
        TestContext testContext = new TestContext("Sample");
        testContext.addValue("sample", new HashMap(Map.of("request", new ArrayList(Arrays.asList(new HashMap(Map.of("key", "value")), new HashMap(Map.of("key2", "value2")))))));

        Assert.assertEquals("value", context.replaceContextVariables(testContext, "${sample.request.key}"));
        Assert.assertEquals("value2", context.replaceContextVariables(testContext, "${sample.request.key2}"));
    }
    ...
    public void testReplaceContextVariablesOfArray() {
        ...
        TestContext testContext = new TestContext("Sample");
        testContext.addValue("sample", new HashMap(Map.of("request", new ArrayList(Arrays.asList(new ArrayList(Arrays.asList(new HashMap(Map.of("key", "value")))), new HashMap(Map.of("key2", "value2")))))));

        Assert.assertEquals("value", context.replaceContextVariables(testContext, "${sample.request[0][0].key}"));
        Assert.assertEquals("value2", context.replaceContextVariables(testContext, "${sample.request[1].key2}"));
        Assert.assertTrue(context.replaceContextVariables(testContext, "${sample.request[0,1]}") instanceof List);
        Assert.assertEquals("", context.replaceContextVariables(testContext, "${sample.request[yes].key2}"));
        Assert.assertEquals("", context.replaceContextVariables(testContext, "${sample.request[20].key2}"));
    ...
    public void testReplaceContextVariablesOfMapArray() {
        ...
        TestContext testContext = new TestContext("Sample");
        testContext.addValue("sample", new ArrayList(Collections.singletonList(new ArrayList(Arrays.asList(new HashMap(Map.of("request", new HashMap(Map.of("key", "value")))), new HashMap(Map.of("key2", "value2")))))));
