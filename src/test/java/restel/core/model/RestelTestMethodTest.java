...
public class RestelTestMethodTest {
    ...
    public void testRestelTestMethod() {
        ...
        Assert.assertEquals(ObjectMapperUtils.convertToJsonNode(Map.of("name","post")), testMethod.getRequestPostCallHook());

        testMethod.setRequestPreCallHook(ObjectMapperUtils.convertToJsonNode(Map.of("name","pre")));
        Assert.assertEquals(ObjectMapperUtils.convertToJsonNode(Map.of("name","pre")), testMethod.getRequestPreCallHook());
